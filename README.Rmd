...
The following example shows how to sample sentences from a built-in database of texts. The result is a dataframe containing five random sentences.
...
The following example shows how to sample words from a built-in text source ("english_words"). The result is a dataframe containing five random words.
