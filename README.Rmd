...
The following example shows how to sample sentences from IMDB movie reviews. The result is a dataframe containing five random sentences.
...
The **textsampler** R-package works with tidy tools and can easily be combined with existing packages such as the rvest R-package. The following example shows how to sample texts from a website. Specifically, the example samples 15 quotes from Julius Ceasar.
...
**texsampler** is released under the [MIT License](https://opensource.org/licenses/MIT)
